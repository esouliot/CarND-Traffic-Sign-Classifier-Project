...
First, I converted the images to grayscale [Luma](https://en.wikipedia.org/wiki/Luma_(video)) using matrix multiplication. Then, I used the Histogram Equalization method from the [Sci-Kit Image Exposure module](http://scikit-image.org/docs/dev/api/skimage.exposure.html), and finally, I reshaped the modified images to fit the 4D shape input for the LeNet function
